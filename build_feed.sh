...
# 2. INSTAGRAM USERNAMES (Parallel)
INSTAGRAM_USERS=(
    "kampus.cadilari" "motorlukuryeiscileri" "toplumsal.ozgurluk.partisi"
    "ozgurlukcugenclik" "peri_hankoca" "doganincocuklari"
    "elyazmalaricom" "heryercocuk"
)
...
if command -v python3 &>/dev/null; then
    python3 "$FEED_DIR/process_images.py"
else
    python "$FEED_DIR/process_images.py"
fi
