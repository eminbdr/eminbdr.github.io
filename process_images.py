...
images_folder = os.path.join(BASE_DIR, 'paradigmal-bulten/images')
feed_path = os.path.join(BASE_DIR, 'paradigmal-bulten/feed.xml')
metadata_path = os.path.join(BASE_DIR, 'paradigmal-bulten/feed_metadata.json')
